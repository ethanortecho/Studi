    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Studi_Analytics.studysession')),
            ],
        ),
        migrations.CreateModel(
            name='StudySessionBreakdown',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_time', models.DateTimeField()),
                ('end_time', models.DateTimeField()),
                ('duration', models.DurationField()),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Studi_Analytics.categories')),
                ('study_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Studi_Analytics.studysession')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_frame', models.CharField(choices=[('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly')], max_length=10)),
